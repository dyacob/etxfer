...
\
                      { rtf2plain,    agafari,        uni }, \
                      { rtf2plain,      alxet,        uni }, \
                      { rtf2plain,     feedel,        uni }, \
                      { rtf2plain,    gezedit,        uni }, \
                      { rtf2plain,   gezfree1,        uni }, \
                      { rtf2plain,   gezfree1,        uni }, \
                      { plain2plain,     sera,        uni }, \
                      { rtf2plain,     washra,        uni }, \
                      { rtf2plain,    washrax,        uni }, \
\
